...
public class intermedio_ejercicios_abdominales extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intermedio_ejercicios_abdominales);
        ...
        ej1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("plancha_abdominales");
                }else{
                    ejercicios.remove("plancha_abdominales");
                }
            }
        });
        ...
        ej2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("plancha_lateral_abdominales");
                }else{
                    ejercicios.remove("plancha_lateral_abdominales");
                }
            }
        });
        ...
        ej3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("encogimiento_abdominales");
                }else{
                    ejercicios.remove("encogimiento_abdominales");
                }
            }
        });
        ...
        ej4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("encogimiento_pelvis_abdominales");
                }else{
                    ejercicios.remove("encogimiento_pelvis_abdominales");
                }
            }
        });
        ...
        ej5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("encogimiento_tronco_abdominales");
                }else{
                    ejercicios.remove("encogimiento_tronco_abdominales");
                }
            }
        });
        ej6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("dead_bug");
                }else{
                    ejercicios.remove("dead_bug");
                }
            }
        });
    ...
    public void ComenzarEntrenamiento(View view){
        if(ejercicios.size()>0){
            ...
            intent.putExtra("tipo","Abdominales");
