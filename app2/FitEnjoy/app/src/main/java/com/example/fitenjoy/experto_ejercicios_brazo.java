...
public class experto_ejercicios_brazo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_experto_ejercicios_brazo);
        ...
        ej1.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("curl_biceps");
                }else{
                    ejercicios.remove("curl_biceps");
                }
            }
        });
        ...
        ej2.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("curl_biceps_barra");
                }else{
                    ejercicios.remove("curl_biceps_barra");
                }
            }
        });
        ...
        ej3.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("banco_scott");
                }else{
                    ejercicios.remove("banco_scott");
                }
            }
        });
        ...
        ej4.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("extension_triceps");
                }else{
                    ejercicios.remove("extension_triceps");
                }
            }
        });
        ...
        ej5.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("extension_triceps_polea");
                }else{
                    ejercicios.remove("extension_triceps_polea");
                }
            }
        });
        ej6.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                if(isChecked){
                    ejercicios.add("patada_triceps");
                }else{
                    ejercicios.remove("patada_triceps");
                }
            }
        });
