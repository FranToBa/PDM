...
public class intermedio_ejercicios_empuje extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_intermedio_ejercicios_empuje);
